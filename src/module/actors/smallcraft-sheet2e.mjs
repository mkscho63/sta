...
export class STASmallCraftSheet2e extends api.HandlebarsApplicationMixin(sheets.ActorSheetV2) {
  static PARTS = {
    charactersheet: {
  ...
  static DEFAULT_OPTIONS = {
    actions: {
      onItemCreate: STASmallCraftSheet2e._onItemCreate,
      onItemEdit: STASmallCraftSheet2e._onItemEdit,
      onItemDelete: STASmallCraftSheet2e._onItemDelete,
      onItemtoChat: STASmallCraftSheet2e._onItemtoChat,
