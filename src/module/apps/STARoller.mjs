...
`;
  ...
  <div class="row">
    ...
    <select name="rollList" class="form-select">
...
`;
  ...
  if (!characterToken) {
    ...
    selectedAttributeValue = character.system.attributes[selectedAttribute]?.value ?? 0;
    selectedDisciplineValue = character.system.disciplines[selectedDiscipline]?.value ?? 0;
  }
