...
export class STASmallCraftSheet extends ActorSheet {
  ...
  /** @override */
    get template() {
      ...
      return `systems/FVTT-StarTrekAdventures/templates/actors/smallcraft-sheet.html`;
    }
  ...
  activateListeners(html) {
    ...
    staActor.staRenderTracks(html, null, null, null, shieldsTrackMax, powerTrackMax, null);
